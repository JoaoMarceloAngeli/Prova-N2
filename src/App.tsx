...
import type { User, Trail, TrailCourse, Course, Plan, Subscription } from "./types";
  ...
  return (
    <>
      <style>{`
        ...
        .jm-section-label { color: #6366f1; font-weight: 700; margin-bottom: 1rem; font-size: 1rem; }
      `}</style>
      ...
      <div className="border rounded-3 p-4 bg-white">
        ...
        <form onSubmit={submitAssoc}>
          <div className="row g-3 align-items-end mb-3">
            <div className="col-12 col-md-4">
              <label className="form-label small fw-semibold" style={{ color: "#6366f1" }}>Trilha</label>
            ...
            <div className="col-12 col-md-4">
              <label className="form-label small fw-semibold" style={{ color: "#6366f1" }}>Curso</label>
            ...
            <div className="col-6 col-md-2">
              <label className="form-label small fw-semibold" style={{ color: "#6366f1" }}>Ordem</label>
...
function CursosTab({
  courses, onAddCourse, onDeleteCourse,
}: {
  courses: Course[];
        ...
        <div className="border rounded-3 overflow-hidden">
          {courses.length === 0 ? (
            ...
            <table className="table table-hover align-middle mb-0">
              <thead className="table-light">
                <tr>
                  <th className="ps-3">Título</th><th>Descrição</th><th className="text-end pe-3">Ação</th>
                </tr>
              </thead>
              <tbody>
                {courses.map(c => (
  ...
  return (
    <>
      <style>{`
        ...
        .jm-plan-badge {
          background: #6366f1; color: #fff; padding: 0.2rem 0.7rem;
      ...
      <div className="d-flex justify-content-between align-items-center mb-4">
        <div className="d-flex align-items-center gap-2">
          ...
          <span className="badge rounded-pill" style={{ background: "#6366f1", fontSize: "0.78rem" }}>
            {plans.length}
          </span>
        </div>
        <button className="btn btn-sm text-white"
          style={{ background: "linear-gradient(135deg, #6366f1, #8b5cf6)" }} onClick={openNew}>
      ...
      {showModal && (
        <div className="jm-plan-modal-overlay"
          ...
          <div className="jm-plan-modal">
            ...
            <div className="p-4">
              <div className="mb-3">
                <label className="form-label fw-semibold small" style={{ color: "#6366f1" }}>
                  Nome do plano *
                </label>
              ...
              <div className="row g-3 mb-3">
                <div className="col-6">
                  <label className="form-label fw-semibold small" style={{ color: "#6366f1" }}>Tipo</label>
                ...
                <div className="col-6">
                  <label className="form-label fw-semibold small" style={{ color: "#6366f1" }}>Preço (R$)</label>
            ...
            <tbody>
              {enriched.map(s => (
                <tr key={s.id}>
                  ...
                  <td>
                    {s.plan && (
                      <span className="badge" style={{ background: "#6366f1", fontSize: "0.75rem" }}>
                        {s.plan.type}
                      </span>
                    )}
                  </td>
              ...
              <div key={p.id} className="col-12 col-sm-6 col-md-4">
                <div className="jm-ps-card h-100">
                  <span className="badge mb-3 px-3 py-2"
                    style={{ background: "#6366f1", borderRadius: 20, fontSize: "0.85rem" }}>
                    {p.type}
                  </span>
  ...
  return (
    <div>
      <style>{`
        ...
        .jm-myplan-card:hover { box-shadow: 0 4px 20px rgba(99,102,241,0.12); border-color: #a5b4fc; }
        ...
        <div className="border rounded-3 p-4 mb-4"
          ...
          <div className="d-flex align-items-center gap-3 flex-wrap">
            <div>
              ...
              <span className="badge" style={{ background: "#6366f1" }}>{currentPlan.type}</span>
            </div>
              ...
              <div key={p.id} className="col-12 col-sm-6 col-md-4">
                <div className={`jm-myplan-card h-100 ${isCurrent ? "active-plan" : ""}`}>
                  <span className="badge mb-2 px-3"
                    style={{ background: "#6366f1", borderRadius: 20 }}>
                    {p.type}
                  </span>
                  ...
                  <button
                    className={`btn w-100 mt-auto ${isCurrent
                      ? "btn-primary"
                      : "btn-outline-primary"
                    }`}
                    disabled={isCurrent}
...
export default function App() {
  ...
  function addCourse(d: { title: string; description: string }) {
    const c: Course = { id: crypto.randomUUID(), ...d, createdAt: new Date().toISOString() };
